...
const CurrencyTypes = {
  NOK: { value: 1.0000, name: "Norwegian kroner", denomination: "kr" },
  EUR: { value: 0.0985, name: "Europian euro", denomination: "€" },
  USD: { value: 0.1891, name: "United States dollar", denomination: "$" },
  GBP: { value: 0.0847, name: "Pound sterling", denomination: "£" },
  INR: { value: 7.8389, name: "Indian rupee", denomination: "₹" },
  AUD: { value: 0.1581, name: "Australian dollar", denomination: "A$" },
  PHP: { value: 6.5189, name: "Filippino peso", denomination: "₱" },
  SEK: { value: 1.0580, name: "Swedish kroner", denomination: "kr" },
  CAD: { value: 0.1435, name: "Canadian dollar", denomination: "C$" },
