...
theAmountOfDays("2025, 03, 14", " untill release ૮₍ ´ ꒳ `₎ა") 
...
printOut("Find the circumference and area")
...
const Price1 = calculateNetPrice(100, "normal")
if (Number.isNaN(Price1)){
  printOut("unknown")
}else{
  printOut("PRICE = " + Price1.toFixed(2) + "NOK")
}
...
const theText1 = modifyString("No Pasta ", 20, "*", false)
